...
project_file = 
# application icon
icon = C:\anaconda3\envs\openmmlab-pyqt-py38\Lib\site-packages\PySide6\scripts\deploy_lib\pyside_icon.ico

[python]
# python path
python_path = C:\anaconda3\envs\openmmlab-pyqt-py38\python.exe
